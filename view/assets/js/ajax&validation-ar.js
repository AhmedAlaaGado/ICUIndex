...
$(function () {
    ...
    $('select').chosen({rtl: true,disable_search_threshold: 10,no_results_text: "للأسف, لم يتم العثور على",search_contains:true,width: "160px"});
